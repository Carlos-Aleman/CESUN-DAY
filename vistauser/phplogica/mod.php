  ...
  function ConsultarProducto($no_prod)
  {
       ...
       include "conexion.php";
        ...
        $conexion=mysqli_connect('db793463892.hosting-data.io','dbo793463892','Andromed@119','db793463892');
              ...
              $sentencia = "SELECT * FROM equiposfinal WHERE numero_nota='".$no_prod."' ";
...
<!DOCTYPE html>
<html>
<title> ACT-EQUIPO-ANDROID</title>
<meta charset="UTF-8">
...
<footer class="w3-container w3-padding-40 w3-light-grey w3-center">
  ...
  <br><br>
  <form class="w3-container" action="modeq2.php" method="POST">
<div class="w3-row-padding">
  <input type="hidden" name="no" value="<?php echo $_GET['no']?> ">
  <div class="w3-half">
   <label class="w3-text-black">Nombre: </label>
      <input  class="w3-input w3-border" type="text" name="nombre"; value="<?php echo $consulta[1] ?>">
  </div>
  <div class="w3-half">
  <label class="w3-text-black">Telefono: </label>
      <input  class="w3-input w3-border" type="text" name="telefono"; value="<?php echo $consulta[2] ?>" >
  </div>
   <div class="w3-half">
  <label class="w3-text-black">Abonos: </label>
      <input  class="w3-input w3-border" type="text" name="abonos"; value="<?php echo $consulta[3] ?>" >
  </div>
   <div class="w3-half">
  <label class="w3-text-black">Status: </label>
      <input  class="w3-input w3-border" type="text" name="status"; value="<?php echo $consulta[4] ?>" >
    <!--    <select id="status" name="status" class="w3-input w3-border">
   ...
   <div class="w3-container w3-padding-5 w3-light-grey">
        <p>
          ...
          <div class="w3-container w3-padding-5 w3-light-grey">
            ...
            <button class="w3-button  w3-amber w3-section w3-padding w3-round-large" onclick="location='../index.php'" style="width: 450px;">Regresar</button>
